...
const IconIClip = () => <svg viewBox="0 0 120 120" fill="none" stroke="currentColor" strokeWidth="0.8" className="w-full h-full">
  ...
  return <div ref={containerRef} className="relative h-[70vh]" onMouseEnter={() => setIsHovering(true)} onMouseLeave={() => setIsHovering(false)}>
      <div className="h-full overflow-hidden">
        ...
        <div className="relative h-full flex items-center overflow-hidden">
          ...
          <AnimatePresence>
            {activeProduct.id === "icut" && <motion.video key="icut-video" initial={{
            opacity: 0
          }} animate={{
            opacity: 1
          }} exit={{
            ...
            duration: 0.8
          }} autoPlay loop muted playsInline className="absolute inset-0 w-full h-full object-cover z-0" src="/videos/icut-bg.mov" />}
          </AnimatePresence>
