            ...
            <div className="h-full grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-20 items-center max-w-7xl mx-auto">
              <div className="relative flex items-center justify-center order-2 lg:order-1">
                <AnimatePresence mode="wait" custom={direction}>
                  <motion.div key={activeSection.id} custom={direction} variants={slideVariants} initial="enter" animate="center" exit="exit" transition={{ duration: 0.6 }} className="w-full">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-2">
                          ...
                          <div className="aspect-[3/4] rounded-xl overflow-hidden border">
                            <img src={productFlat} alt="原图" className="w-full h-full object-cover" />
                          </div>
                        </div>
                        <div className="space-y-2">
                          <span className="inline-block px-3 py-1 rounded-full text-xs font-medium bg-primary text-primary-foreground">AI 生成</span>
                          <div className="aspect-[3/4] rounded-xl overflow-hidden border">
                            <img src={productModel} alt="AI生成" className="w-full h-full object-cover" />
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <div className="relative flex items-center order-1 lg:order-2">
                <AnimatePresence mode="wait" custom={direction}>
                  <motion.div key={activeSection.id + "-text"} custom={direction} variants={slideVariants} initial="enter" animate="center" exit="exit" transition={{ duration: 0.5 }} className="w-full max-w-lg space-y-6">
