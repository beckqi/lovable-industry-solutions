      ...
      <div className="grid grid-cols-3 md:grid-cols-5 gap-8 md:gap-12 mb-16">
        {logos.map((logo, index) => (
          <motion.div 
            ...
            className="flex items-center justify-center py-6 px-4 group border border-border rounded-lg bg-background/50 hover:border-primary/30 transition-all duration-300"
          >
            {logo.image ? (
              <img 
                src={logo.image} 
